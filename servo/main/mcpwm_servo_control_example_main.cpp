...
#define NUM_SERVOS 3
const int SERVO_PINS[NUM_SERVOS] = {2, 4, 5}; // D2, D4, D5
...
// Smoothly approach target (simple low-pass filter)
void update_servos() {
    const float alpha = 0.25f; // Smoothing factor (0=slow, 1=instant)
...
extern "C" void app_main(void) {
    ...
    ESP_LOGI(TAG, "Servo PWM UART Controller started. D2/D4/D5, 100Hz update.");
